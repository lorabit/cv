...
Room 803, Lander Building, Wensan Road,   & +87-18768117383 \\
Xi Hu District, Hangzhou 3100000, China     & \email{lorabit@126.com}\\
\end{tabular}
...
\textbf{iOS Dev Leader} \hfill {Aug 2015 to Present}
\begin{outerlist}
...
\item[] From Network Technology CO.,LTD,\\
        ...
        \item Build minimum viable products and design experiements to verify key business assumptions 
        \end{innerlist}
\end{outerlist}
...
\item[] Hangzhou Denegrii Technology CO.,LTD,\\
        ...
        \item Build medical bid data system
        \end{innerlist}
\end{outerlist}


\textbf{Software Development Engineer (Full-stack Developer)} \hfill {July 2014 to May 2015}
\begin{outerlist}
